...
public class MainToolWinv0 implements ToolWindowFactory {
    ...
    private void softComplain(String message) {
        //new ComplainAction(this, message, null, true).execute();
    }
    ...
    private void complain(String error, Exception e) {
        ...
        } //else new ComplainAction(this, error, e, false).execute();
    }
    ...
    public Tree getTreeTransformations() {
        //if ( treeTransformations == null ) treeTransformations = new Tree();
        return treeTransformations;
    }


    public JLabel getTPCount() {
        //if ( lblTPCount == null ) lblTPCount = new JBLabel();
        return lblTPCount;
    }
