...
public class ShowAllClasifierAction extends TestEyeAction {
    ...
    public ShowAllClasifierAction(FilterPanel panel) {
    ...
    public void actionPerformed(final AnActionEvent event) {
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(event.getProject(),
            ...
            public void run(@NotNull ProgressIndicator progressIndicator) {
                try {
                    ...
                    component.showAll(progressIndicator);
                } catch (Exception e) {
        ...
        if ( filterPanel != null ) {
            filterPanel.checkAllNoTriggerEvent();
            filterPanel.setShowIntersectionNoTriggerEvent(false);
        }
    }
}
